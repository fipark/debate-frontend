...
import { ArrowLeft, ThumbsDown, ThumbsUp, ShieldCheck } from "lucide-react";
...
const TOPICS = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        desc: "CRISPR 등 유전자 편집 기술의 의료적 활용과 윤리적 문제를 토론합니다.",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        desc: "기본소득제의 경제적 타당성과 사회적 영향을 토론합니다.",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        desc: "교육 환경에서 스마트폰 사용의 장단점을 분석하고 균형을 논의합니다.",
      },
      {
        id: "society-carbon-tax",
        level: "중급",
        title: "기후변화 대응을 위한 탄소세는 필요한가?",
        desc: "탄소세 도입의 경제적 영향과 효과성에 대해 토론합니다.",
      },
      {
        id: "society-animal-test",
        level: "초급",
        title: "동물실험은 금지되어야 하는가?",
        desc: "동물실험의 필요성과 동물 권리 보호 사이의 균형을 토론합니다.",
      },
    ],
  },
];
